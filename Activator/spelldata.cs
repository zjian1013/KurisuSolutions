...
namespace Activator
{
    public class spelldata
    {
        ...
        static spelldata()
        {
            ...
            spells.Add(new spelldata
            {
                SDataName = "kalistamysticshotmis",
                ChampionName = "kalista",
                Slot = SpellSlot.Q,
                CastRange = 1150f,
                Delay = 250f,
            ...
            spells.Add(new spelldata
            {
                SDataName = "skarnerfracturemissilespell",
                ChampionName = "skarner",
                Slot = SpellSlot.E,
                CastRange = 1100f,
                Delay = 500f,
