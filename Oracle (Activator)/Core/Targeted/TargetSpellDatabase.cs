    ...
    public static class TargetSpellDatabase
    {
        ...
        static TargetSpellDatabase()
        {
            Spells = new List<TargetSpellData>
            {
                ...
                new TargetSpellData("akali", "akalismokebomb", SpellSlot.W, SpellType.Skillshot, CcType.Slow, 700, 500, 0, false, true),
                ...
                #region Amumu
                new TargetSpellData("amumu", "bandagetoss", SpellSlot.Q, SpellType.Skillshot, CcType.Stun, 1100, 500, 2000, true),
                new TargetSpellData("amumu", "auraofdespair", SpellSlot.W, SpellType.Self, CcType.No, 300, 470, float.MaxValue),
                new TargetSpellData("amumu", "tantrum", SpellSlot.E, SpellType.Self, CcType.No, 350, 0, float.MaxValue),
                new TargetSpellData("amumu", "curseofthesadmummy", SpellSlot.R, SpellType.Self, CcType.Stun, 550, 0, float.MaxValue, true),
                ...
                new TargetSpellData("annie", "infernalguardian", SpellSlot.R, SpellType.Skillshot, CcType.No, 600, 250, float.MaxValue, true),
                ...
                new TargetSpellData("ashe", "enchantedcrystalarrow", SpellSlot.R, SpellType.Skillshot, CcType.Stun, 50000, 500, 1600, true),
                ...
                new TargetSpellData("blitzcrank", "staticfield", SpellSlot.R, SpellType.Self, CcType.Silence, 600, 0, 0, true),
                ...
                new TargetSpellData("cassiopeia", "cassiopeiapetrifyinggaze", SpellSlot.R, SpellType.Skillshot, CcType.Stun, 875, 300, float.MaxValue, true),

                #endregion Cassiopeia

                #region Chogath
                new TargetSpellData("chogath", "rupture", SpellSlot.Q, SpellType.Skillshot, CcType.Knockup, 1000, 550, float.MaxValue, true),
                ...
                new TargetSpellData("chogath", "feast", SpellSlot.R, SpellType.Targeted, CcType.No, 230, 0, 500, true),
                ...
                #region Darius
                new TargetSpellData("darius", "dariuscleave", SpellSlot.Q, SpellType.Self, CcType.No, 425, 0, 0),
                new TargetSpellData("darius", "dariusnoxiantacticsonh", SpellSlot.W, SpellType.Self, CcType.Slow, 210, 0, 0),
                new TargetSpellData("darius", "dariusaxegrabcone", SpellSlot.E, SpellType.Skillshot, CcType.Pull, 540, 0, 0),
                new TargetSpellData("darius", "dariusexecute", SpellSlot.R, SpellType.Targeted, CcType.No, 460, 150, 20, true),
                ...
                new TargetSpellData("diana", "dianateleport", SpellSlot.R, SpellType.Targeted, CcType.No, 800, 0, 1500, true),
                ...
                new TargetSpellData("elise", "elisespiderqcast", SpellSlot.Q, SpellType.Targeted, CcType.No, 375, 500, float.MaxValue),
                ...
                new TargetSpellData("galio", "galioidolofdurand", SpellSlot.R, SpellType.Self, CcType.Taunt, 560, 0, float.MaxValue, true),
                ...
                new TargetSpellData("gangplank", "cannonbarrage", SpellSlot.R, SpellType.Skillshot, CcType.Slow, 20000, 500, 500, true),
                ...
                new TargetSpellData("graves", "graveschargeshot", SpellSlot.R, SpellType.Skillshot, CcType.No, 1000, 500, 1200, true),
                ...
                new TargetSpellData("hecarim", "hecarimult", SpellSlot.R, SpellType.Skillshot, CcType.Fear, 1350, 500, 1200, true),
                ...
                new TargetSpellData("heimerdinger", "heimerdingereult", SpellSlot.R, SpellType.Skillshot, CcType.Stun, 970, 230, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("irelia", "ireliaequilibriumstrike", SpellSlot.E, SpellType.Targeted, CcType.Stun, 325, 500, float.MaxValue, true),
                ...
                #region Janna
                new TargetSpellData("janna", "howlinggale", SpellSlot.Q, SpellType.Skillshot, CcType.Knockup, 1800, 250, float.MaxValue),
                ...
                new TargetSpellData("jinx", "jinxrwrapper", SpellSlot.R, SpellType.Skillshot, CcType.No, 25000, 0, float.MaxValue, true),
                ...
                new TargetSpellData("kassadin", "riftwalk", SpellSlot.R, SpellType.Skillshot, CcType.No, 675, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("kayle", "judicatorintervention", SpellSlot.R, SpellType.Targeted, CcType.No, 900, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("khazix", "khazixr", SpellSlot.R, SpellType.Self, CcType.No, 0, 0, float.MaxValue, false, true, true),
                new TargetSpellData("khazix", "khazixrlong", SpellSlot.R, SpellType.Self, CcType.No, 0, 0, float.MaxValue, false, true, true),
                ...
                new TargetSpellData("lissandra", "lissandraw", SpellSlot.W, SpellType.Self, CcType.Snare, 450, 500, float.MaxValue, true),
                new TargetSpellData("lissandra", "lissandrae", SpellSlot.E, SpellType.Skillshot, CcType.No, 1050, 500, 850),
                new TargetSpellData("lissandra", "lissandrar", SpellSlot.R, SpellType.Targeted, CcType.Stun, 550, 0, float.MaxValue, true),
                ...
                new TargetSpellData("maokai", "maokaiunstablegrowth", SpellSlot.W, SpellType.Targeted, CcType.Snare, 650, 500, float.MaxValue, true),
                new TargetSpellData("maokai", "maokaisapling2", SpellSlot.E, SpellType.Skillshot, CcType.Slow, 1100, 500, 1750),
                new TargetSpellData("maokai", "maokaidrain3", SpellSlot.R, SpellType.Targeted, CcType.No, 625, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("masteryi", "highlander", SpellSlot.R, SpellType.Self, CcType.No, 0, 370, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("nasus", "nasusr", SpellSlot.R, SpellType.Skillshot, CcType.No, 1, 500, float.MaxValue, false ,false, true),
                ...
                new TargetSpellData("olaf", "olafragnarok", SpellSlot.R, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("poppy", "poppydiplomaticimmunity", SpellSlot.R, SpellType.Targeted, CcType.No, 900, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("rammus", "tremors2", SpellSlot.R, SpellType.Self, CcType.No, 300, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("rengar", "rengarr", SpellSlot.R, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, false, true),

                #endregion Rengar

                #region Rek'Sai
                //new TargetSpellData("reksai", "reksaiq", SpellSlot.Q, SpellType.Self, CcType.No, 0, 0, float.MaxValue),
                //new TargetSpellData("reksai", "reksaiqburrowed", SpellSlot.W, SpellType.Self, CcType.No, 1650, 500, float.MaxValue),
                //new TargetSpellData("reksai", "reksaiw", SpellSlot.W, SpellType.Self, CcType.No, 0, 350, float.MaxValue),
                //new TargetSpellData("reksai", "reksaiwburrowed", SpellSlot.W, SpellType.Self, CcType.Knockup, 250, 500, float.MaxValue),
                //new TargetSpellData("reksai", "reksaie", SpellSlot.E, SpellType.Targeted, CcType.No, 250, 0, float.MaxValue),
                //new TargetSpellData("reksai", "reksaieburrowed", SpellSlot.E, SpellType.Skillshot, CcType.No, 350, 900, float.MaxValue),
                //new TargetSpellData("reksai", "reksair", SpellSlot.R, SpellType.Targeted, CcType.No, float.MaxValue, 1000, float.MaxValue),          
                #endregion
                ...
                new TargetSpellData("shen", "shenstandunited", SpellSlot.R, SpellType.Targeted, CcType.No, 25000, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("singed", "insanitypotion", SpellSlot.R, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, false, true),

                #endregion Singed

                #region Sion
                new TargetSpellData("sion", "sionq", SpellSlot.Q, SpellType.Skillshot, CcType.Stun, 600, 2000, 1600),
                new TargetSpellData("sion", "sionw", SpellSlot.W, SpellType.Self, CcType.No, 550, 500, float.MaxValue),
                new TargetSpellData("sion", "sione", SpellSlot.E, SpellType.Skillshot, CcType.Slow, 1000, 500, float.MaxValue),
                ...
                new TargetSpellData("sivir", "sivirr", SpellSlot.R, SpellType.Self, CcType.No, 1000, 500, float.MaxValue, false, false, true),
                ...
                #region Soraka
                new TargetSpellData("soraka", "sorakaq", SpellSlot.Q, SpellType.Skillshot, CcType.No, 675, 500, float.MaxValue),
                new TargetSpellData("soraka", "sorakaw", SpellSlot.W, SpellType.Targeted, CcType.No, 750, 500, float.MaxValue),
                new TargetSpellData("soraka", "sorakae", SpellSlot.E, SpellType.Skillshot, CcType.Silence, 725, 500, float.MaxValue),
                new TargetSpellData("soraka", "sorakar", SpellSlot.R, SpellType.Self, CcType.No, 25000, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("taric", "tarichammersmash", SpellSlot.R, SpellType.Self, CcType.No, 400, 500, float.MaxValue, true),
                ...
                new TargetSpellData("thresh", "threshe", SpellSlot.E, SpellType.Skillshot, CcType.Knockback, 515, 200, float.MaxValue),
                new TargetSpellData("thresh", "threshrpenta", SpellSlot.R, SpellType.Skillshot, CcType.Slow, 420, 300, float.MaxValue, true, false, true),
                ...
                new TargetSpellData("tryndamere", "undyingrage", SpellSlot.R, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, false, true),

                #endregion Tryndamere

                #region Twitch
                new TargetSpellData("twich", "hideinshadows", SpellSlot.Q, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, true),
                ...
                new TargetSpellData("udyr", "udyrphoenixstance", SpellSlot.R, SpellType.Self, CcType.No, 0, 500, float.MaxValue, false, false, true),
                ...
                new TargetSpellData("warwick", "infiniteduress", SpellSlot.R, SpellType.Targeted, CcType.Suppression, 700, 500, float.MaxValue, true),
