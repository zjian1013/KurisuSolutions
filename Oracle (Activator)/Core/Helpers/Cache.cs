...
namespace Oracle.Core.Helpers
{
    ...
    public class Cache : ObjectCache
    {
            ...
            string regionName = null)
        {
            ...
            {
                Console.WriteLine("An exception occured while invoking the EntryUpdateCallbacks: {0}", e);
            }
        }
            ...
            string regionName = null)
        {
            ...
            {
                Console.WriteLine("An exception occured while invoking the CacheEntryRemovedCallback: {0}", e);
            }
        }
