...
namespace KurisuMorgana
{
    ...
    internal class KurisuMorgana
    {
        ...
        private void MorganaMenu()
        {
            ...
            morgDraws.AddItem(new MenuItem("drawQ", "Draw Q")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            morgDraws.AddItem(new MenuItem("drawW", "Draw W")).SetValue(new Circle(false, Color.FromArgb(150, Color.White)));
            morgDraws.AddItem(new MenuItem("drawE", "Draw E")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            morgDraws.AddItem(new MenuItem("drawR", "Draw R")).SetValue(new Circle(true, Color.FromArgb(150, Color.White)));
            _config.AddSubMenu(morgDraws);

            var morgBind = new Menu("Morgana: Dark Binding", "bind");
            morgBind.AddItem(new MenuItem("useq", "Enable")).SetValue(true);
            morgBind.AddItem(new MenuItem("minuseq", "Mininimum distance")).SetValue(new Slider(0, 0, 250));
            morgBind.AddItem(new MenuItem("hitchance", "Hitchance")).SetValue(new StringList(new[] { "Low", "Medium", "High" }, 2));
            morgBind.AddItem(new MenuItem("", ""));
            morgBind.AddItem(new MenuItem("qdash", "Auto-Q dashing enemies")).SetValue(true);
            morgBind.AddItem(new MenuItem("qimmobile", "Auto-Q immoble enemies")).SetValue(true);
            morgBind.AddItem(new MenuItem("qgap", "Auto-Q gapclosing enemies")).SetValue(true);
            _config.AddSubMenu(morgBind);

            var morgSoil = new Menu("Morgana: Torment Soil", "soil");
            morgSoil.AddItem(new MenuItem("usew", "Enable")).SetValue(true);
